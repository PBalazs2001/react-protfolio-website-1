      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>balazspercsi@gmail.com</h5>
            <a href="mailto:balazspercsi@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <RiMessengerLine className='contact__option-icon' />
            <h4>Messenger</h4>
            <h5>Balázs Pércsi</h5>
            <a href="https://m.me/balazs.percsi" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
